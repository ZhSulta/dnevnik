...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'School', fields ['city']
        db.delete_unique('models_school', ['city_id'])

        # Changing field 'School.city'
        db.alter_column('models_school', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['models.City']))


    def backwards(self, orm):
        
        # Changing field 'School.city'
        db.alter_column('models_school', 'city_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['models.City'], unique=True))

        # Adding unique constraint on 'School', fields ['city']
        db.create_unique('models_school', ['city_id'])
